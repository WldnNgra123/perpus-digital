    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <form @submit.prevent="kirimData">
          ...
          <div v-if="form.keanggotaan == '3'">
            <div class="row">
              <div class="col-md-4">
                <select v-model="form.tingkatan" class="tingkat form-control-lg form-select rounded-5 mb-2">
          ...
          <button type="submit" class="btn btn-danger btn-lg rounded-5 px-5">kirim</button>
        </form>
      </div>
    </div>
  </div>
